...
export const DashuraiServicesSection = () => {
  return (
    <div id="about" className="bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 box-border caret-transparent mt-[72px] py-[72px] md:mt-[120px] md:py-[120px]">
